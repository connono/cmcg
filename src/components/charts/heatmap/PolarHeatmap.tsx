...
const initialValue = {
  ...
  basic_yField: '',
  basic_colorField: '',
  basic_coordinate_innerRadius: '0.1',
};
...
const formToConfig = (values: any) => {
  ...
  const config = {
    ...
    coordinate: {
      type: 'polar',
      cfg: {
        innerRadius: values.basic_coordinate_innerRadius,
      },
    },
    meta: {
      [xField]: {
...
export const polarHeatmapSchema = {
  schema,
  SchemaField,
  initialValue,
  formToConfig,
...
export const PolarHeatmapRender = async (
  container?: any,
  config?: any,
  callback?: any,
) => {
